...
Step2:
Run `npm i` inside the 'frontend' directory to install packages mentioned in file package.json

Step3:
Run `npm i` inside the 'backend' directory to install packages mentioned in file package.json
